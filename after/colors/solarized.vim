...
" hi StatusLine   cterm=underline         ctermbg=0       ctermfg=fg
" hi StatusLineNC cterm=underline         ctermbg=8       ctermfg=fg
" hi VertSplit    cterm=bold              ctermbg=8       ctermfg=fg
" hi WildMenu     cterm=underline,bold    ctermbg=0       ctermfg=15
